...
def get_rate_limiter(request: Request) -> RateLimiter:
    ...
    return rate_limiter
DEFAULT_ANONYMOUS_USER_ID = str(uuid.uuid5(uuid.NAMESPACE_DNS, "devops-llm-agent-anonymous-user"))
DEFAULT_SYSTEM_USER_ID = str(uuid.uuid5(uuid.NAMESPACE_DNS, "devops-llm-agent-system-user"))
